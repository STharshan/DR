...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "They are efficient and customer friendly. They are well equipped to do their tinckering and painting work. Pricing are bit on higher side Also they have enough skilled workers for jobs.",
    name: "Carline Fernando",
  },
