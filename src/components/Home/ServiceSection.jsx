...
const services = [
  ...
  },
  {
    title: "Mechanical",
    desc: `
The repair and maintenance of a vehicle's engine, transmission, brakes, suspension, and other vital components
​`,
    image: "/gray.avif",
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {services.map((service, index) => (
             ...
             hover:scale-105 active:scale-105 bg-white hover:shadow-primary hover:border-primary/80 dark:bg-[#242427]/105 transition-all duration-300"
                data-aos="fade-up"
